              ...
              >
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-black/80 border border-white/10 rounded-xl text-white focus:outline-none focus:border-[#fe5900] focus:ring-1 focus:ring-[#fe5900] transition-colors appearance-none"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-black/80 border border-white/10 rounded-xl text-white focus:outline-none focus:border-[#fe5900] focus:ring-1 focus:ring-[#fe5900] transition-colors"
                  />
                </div>
              </motion.div>
